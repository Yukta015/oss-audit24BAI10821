...
|---|---|
| **Name** | Yukta Singh |
| **Roll Number** | 24BAI10821 |
| **Repository** | `oss-audit-24BAI10821` |
...
```bash
git clone https://github.com/<your-Yukta015>/oss-audit-24BAI10821.git
cd oss-audit-24BAI10821
```
